...
void	Client::setQueryString(std::string q)		{query_string = q;}
...
std::string                         Client::getQueryString()   const { return query_string; }
...
bool                                Client::isChunkedBody()    const { return chunked_body; }
